    ...
    for batch_i, (imgs, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        with torch.no_grad():
            ...
            if is_training:  # if model has loss hyperparameters
                modified_targets = map_labels_to_cluster(targets, clusters, class_to_cluster_list, 0, device)
...
if __name__ == '__main__':
    ...
    if opt.task == 'test_single':  # (default) test normally
