...
from adaptive_test import test  # import test.py to get mAP after each epoch
from models import *
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cluster_idx', type=int, help='Active Branch')
    ...
    if opt.clusters: 
        opt.clusters = check_file(opt.clusters)
    print(opt)
